<?php 
   ...
   else if($this->session->userdata('email_zone_manager'))
   {
        ...
        <section class="scrollable padder wrapper">            
            <div class="row">
				...
				<section class="panel panel-default">
                 ...
                 <input type="hidden" name="zone_manager_id" value="<?php echo $zone_manager_id; ?>">
	             <div class="panel-body">
	                   ...
	                   <div class="form-group">
	                    ...
	                    <div class="form-group">
				                 <label > Plan </label> 
				                 <br/>
        				<select name="txtPlan" id="gender" style="height: 30px;width: 100%;" class="" required="">
