            ...
            <section class="w-f scrollable">
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">                                
                <nav class="nav-primary hidden-xs">
                  <ul class="nav">
                    <li  class="active">
                      <a href="<?php echo base_url().'index.php/Home/admin';?>" class="active">
                    ...
                    <li>
                        ...
                        <ul class="nav lt">
                              <li>
                                   <a href="<?php echo base_url().'index.php/zone_manager/add_zone_manager/';?>">                            
                                   <i class="fa fa-angle-right"></i>
                                   <span>Add Zone Manager</span>
                                   </a>
                              </li>
                              <li>
                                   <a href="<?php echo base_url().'index.php/zone_manager/list_zone_manager/';?>" >                            
                                   <i class="fa fa-angle-right"></i>
                                   <span>List of Zone Manager</span>
                                   </a>
                              </li>
                              <li>
                                   <a href="<?php echo base_url().'index.php/zone_manager/associate_with_client/';?>" >                            
                                   <i class="fa fa-angle-right"></i>
                    ...
                    <li>
                      ...
                      <ul class="nav lt">
                        ...
                        <li>
                          ...
                          <li>
                            <a href="<?php echo base_url().'index.php/admin_client/select_plan_list/';?>" >                            
                            <i class="fa fa-angle-right"></i>
                            <span>List Plan</span>
                          </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url().'index.php/Home/change_password_admin/';?>" >                            
                            <i class="fa fa-angle-right"></i>
